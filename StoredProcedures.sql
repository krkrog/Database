...
Use MusicStore;              ## Stored procedure - Detail and total sales for the year, group by each month
Delimiter //
...
use MusicStore;        ## Create a stored procedure that will displat all returns grouped by month
Delimiter //
